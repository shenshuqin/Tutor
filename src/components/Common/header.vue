 ...
 <div class="commonTopbar">
            <div class="w pos min_width">
               ...
               <!-- <img  alt="" :src='imgStr' class="avatar"> -->
                <div class="block avatarimg"><el-avatar :size="30" :src="avatar" class="avatar"></el-avatar></div>
                </div> 
                <div class="bar_right">
    ...
    data () {
        ...
        value: '',
         header:{ 
                ...
                "Authorization": "Bearer " + getCookie("AccessToken1")
        },
...
<style>
    ...
    .commonTopbar_city .el-input__inner ,#select-option{
...
<style  scoped>
  .commonTopbar{
    ...
    .commonTopbar_jianzhi,.commonTopbar_shouye,.commonTopbar_huiyuan,.commonTopbar_huwu,.commonTopbar_geren{
        height: 50px;
        line-height: 50px;
        cursor: pointer;
        z-index: 999;
