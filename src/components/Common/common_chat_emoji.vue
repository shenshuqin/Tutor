...
<template>
  <div class="common_chat_emoji-wrapper common_chat_emoji-wrapper-global">
    <a href="javascript:void(0)" @click="toggleFaceHidden">
      ...
      <svg class="icon smile" id="icons" aria-hidden="true">
        <use xlink:href="#icon-smile"></use>
      </svg>
    </a>
    <div class="list-wrapper" v-show="!faceHidden">
      <div class="list-inner" @click="selectFace">
        <a v-for="(item, index)  in qqemojiList" :key="index" class="item qqemoji" :title="item" :text="[item]"
...
.common_chat_emoji-wrapper-global {
  .qqemoji {
    ...
    font-size: 0;
    text-indent: -999em;
    background: url("../../assets/images/qqEmoji.png") 0 0 no-repeat;
  }
