          ...
          <div class="register-form">
            <form class="el-form">
                ...
                <div class="el-form-item__content">
                  <div class="el-input el-input--prefix">
                    <!----><input type="text" autocomplete="off" placeholder="用户名" v-model.trim="username"
                      @focus="focus_user()" @blur="blur_rguser()" class="el-input__inner"><span
                      class="el-input__prefix"><img src="https://qiniu-image.qtshe.com/pc_new_login_user.png"
              ...
              <div class="el-form-item" v-show="pass_reg">
                <div class="el-form-item__content">
                  <div class="el-input el-input--prefix">
                    <input @focus="focus_pass()" type="password" autocomplete="off" placeholder="密码" maxlength="6"
                      v-model.trim="password" class="el-input__inner"><span class="el-input__prefix"><img
              ...
              <div class="el-form-item" v-show="yzm">
                <div class="el-form-item__content">
                  ...
                  <div class="count-down"><button type="button" class="el-button count-down-button el-button--primary">
              ...
              <div class="el-form-item" v-show="tup">
                <div class="el-form-item__content">
                  <div class="el-input">
                    <input type="text" @focus="focus_tpcode()" v-model.trim="tpcode" autocomplete="off"
                      placeholder="图片验证码" maxlength="4" class="el-input__inner">
                  </div>
              ...
              <div class="pic-verify" v-show="tup_yz"><span @click="getIdentifyingCode(true)">换一个</span> <img
                  id="imgIdentifyingCode" src="../../assets/images/yzm.png" alt="">
              </div>
            ...
            <div class="content"><span>点击「下一步」按钮，代表你同意</span> <span class="blue">《龙呤商户协议》</span><span>与</span><span
                class="blue">《龙呤商户隐私协议》</span></div>
          </div>
...
export default {
  ...
  methods: {
    ...
    register1 () {
      ...
      axios({
        url: 'https://dev-ao5dx3e.lonltech.com:646/api/user/register',
        method: 'post',
        dataType: 'json',
        data: data,
        headers: this_.header
          ...
          if (res.data.Code === 1) {
            ...
            switch (Msg) {
              ...
              case 1:
                ...
                this.$router.push('/usercenter/accountSetting')
            }
          } else {
            this_.warn = true
            this_.msg_warn = '注册失败'
